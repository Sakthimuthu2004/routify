...
import EmptyHabitsPlaceHolder from "../../../EmptyPlaceHolders/HabitsEmptyPlaceHolder";
import { v4 as uuidv4 } from "uuid";
import convertIconsToTextOfHabits from "../../../utils/allHabitsUtils/editHabits";
        ...
        <div className="  w-full">
          ...
          <div className="flex gap-2 justify-between   ">
            <div className="flex gap-2 items-center">
              <FontAwesomeIcon
                className="  p-3 rounded-full w-4 h-4 bg-green-900 text-white"
                height={20}
                width={20}
