...
//             : defaultColor.backgroundSlate,
//         }}
//         className={`w-full mt-8 flex justify-center     transition-all ${isExpanded ? "h-48" : "h-0"
//           }`}
//       >
  ...
  return (
    ...
    >
      ...
      <div className="flex justify-between items-center">
        <div className="flex gap-3 items-center">
          {/* Icon */}
          <div className="bg-green-900 w-10 h-10 rounded-full p-3 flex items-center justify-center text-white">
            <FontAwesomeIcon icon={faBook} />
          </div>
          {/* Habit Name */}
          <span>{habit.name}</span>
