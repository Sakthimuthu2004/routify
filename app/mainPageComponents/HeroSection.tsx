  ...
  return (
    <div className="flex flex-col mx-16 items-center mt-[100px] gap-6 ">
      <span className="font-bold text-3xl text-center">
        Build the habits that <span className="text-green-900">matter!</span>
      </span>
      ...
      <button
        className={`block text-sm font-light rounded-lg  px-9 py-3  text-white transition bg-green-900   focus:outline-none  `}
        type="button"
      >
        {`Let's get started!`}
      </button>
