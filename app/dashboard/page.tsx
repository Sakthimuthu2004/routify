...
//   return (
//     <div
//       className={`w-full h-full bg-black fixed top-0 left-0 opacity-20 z-40 ${openSideBar || openHabitWindow || openConfirmationWindow || openAreaForm
//         ? "fixed"
//         : "hidden"
//         }`}
//     ></div>
    ...
    const fetchData = async () => {
      ...
      if (clerkUserId) {
        try {
          ...
          console.error("Error fetching habits or generating insights", error);
          setHabits([]);
          setInsights([]);
        }
      } else {
